...
* (coverage) The 'coverage' command will be quiet when generating lcov report.
  This change only affect bazel 7.x.x and above.  Previously generating the
  lcov could put text onto stdout/stderr which resulted in failures.
