...
# Generated by python/private/platform_runtime_repo.bzl
...
def _platform_runtime_repo_impl(rctx):
    ...
    output = repo_utils.execute_checked_stdout(
        rctx,
        op = "platform_runtime_repo.GetPythonInfo({})".format(rctx.name),
        arguments = [
            interpreter_path,
...
platform_runtime_repo = repository_rule(
    implementation = _platform_runtime_repo_impl,
    doc = """\
