...
def _host_os_alias_impl(repository_ctx):
    ...
    repository_ctx.file("BUILD.bazel", """# Generated by python/repositories.bzl
package(default_visibility = ["//visibility:public"])
...
""".format(
    ...
    repository_ctx.file("defs.bzl", content = """# Generated by python/repositories.bzl
...
_host_os_alias = repository_rule(
    ...
    attrs = {
        "user_repository_name": attr.string(
            mandatory = True,
            doc = "base name for all created repos, like 'python38'",
        ),
    },
)
