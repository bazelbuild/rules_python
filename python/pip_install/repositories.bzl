...
_RULE_DEPS = [
    ...
    (
        "pypi__setuptools",
        "https://files.pythonhosted.org/packages/20/f7/205a71cc9cc68f23afd9f3083002d0fb0a8c2277baf41a528395552e13c0/setuptools-57.5.0.tar.gz",
        "d9d3266d50f59c6967b9312844470babbdb26304fe740833a5f8d89829ba3a24",
    ),
    (
        "pypi__wheel",
