...
def _pip_repository_impl(rctx):
    ...
    if rctx.attr.incremental:
        ...
        args = [
            python_interpreter,
            "-m",
            "python.pip_install.extract_wheels.lib.parse_requirements_to_bzl",
            "--requirements_lock",
        ...
        args = [
            python_interpreter,
            "-m",
            "python.pip_install.extract_wheels.lib.extract_wheels",
            "--requirements",
...
def _whl_library_impl(rctx):
    ...
    args = [
        python_interpreter,
        "-m",
        "python.pip_install.extract_wheels.lib.extract_single_wheel",
        "--requirement",
