...
| requires_file |  Requirements file for list of requirements for this package. which will be additive after `requires`   | <a href="https://bazel.build/docs/build-ref.html#labels">Label</a> | optional | None |
