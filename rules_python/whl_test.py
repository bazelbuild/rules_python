...
class WheelTest(unittest.TestCase):
  ...
  @patch('platform.python_version_tuple', return_value=('2','7','13'))
  ...
  @patch('platform.python_version_tuple', return_value=('3','3','0'))
  ...
  def test_mock_whl_extras(self, *args):
    ...
    self.assertEqual(set(wheel.dependencies(extra='docs')), set(['six', 'funcsigs', 'pbr', 'sphinx']))
    self.assertEqual(set(wheel.dependencies(extra='test')), set(['six', 'funcsigs', 'pbr', 'unittest2']))

  @patch('platform.python_version', return_value='3.0.0')
  @patch('platform.python_version_tuple', return_value=('3','0','0'))
  def test_mock_whl_extras_3_0(self, *args):
    td = TestData('mock_whl/file/mock-2.0.0-py2.py3-none-any.whl')
    wheel = whl.Wheel(td)
    self.assertEqual(set(['docs', 'test']), wheel.extras())
    self.assertEqual(set(wheel.dependencies(extra='docs')), set(['six', 'funcsigs', 'pbr', 'sphinx', 'Pygments', 'jinja2']))
    self.assertEqual(set(wheel.dependencies(extra='test')), set(['six', 'funcsigs', 'pbr', 'unittest2']))
  ...
  @patch('platform.python_version_tuple', return_value=('3','4','0'))
