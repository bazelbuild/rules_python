...
_annotations = {}
_repo_names_to_short_reqs = {"pip_certifi": "certifi==2021.10.8", "pip_charset_normalizer": "charset-normalizer==2.0.12", "pip_idna": "idna==3.3", "pip_requests": "requests==2.27.1", "pip_urllib3": "urllib3==1.26.9"}
